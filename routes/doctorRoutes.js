...
const { parseISO, setHours, setMinutes, addMinutes, format, isWithinInterval } = require("date-fns")
...
//       setHours(date, Number.parseInt(doctor.workingHours.start.split(":")[0])),
//       Number.parseInt(doctor.workingHours.start.split(":")[1]),
//     )
//     const endTime = setMinutes(
//       setHours(date, Number.parseInt(doctor.workingHours.end.split(":")[0])),
//       Number.parseInt(doctor.workingHours.end.split(":")[1]),
//     )
